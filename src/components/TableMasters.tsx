    ...
    <Table>
      <TableHeader>
        <TableRow>
          ...
          <TableHead>{t("adminMasters.tableHeaders.master")}</TableHead>
          <TableHead>{t("adminMasters.tableHeaders.email")}</TableHead>
          <TableHead>{t("adminMasters.tableHeaders.contact")}</TableHead>
          <TableHead>{t("adminMasters.tableHeaders.services")}</TableHead>
          <TableHead>{t("adminMasters.tableHeaders.actions")}</TableHead>
        </TableRow>
      </TableHeader>
            ...
            <TableRow key={__}>
                ...
                <HoverCard>
                  <HoverCardTrigger asChild>
                    <img
                      ...
                      src={`${import.meta.env.VITE_THUMBS_URL}/${m.thumbnail}`}
                      alt=""
                    />
                  </HoverCardTrigger>
                  <HoverCardContent>
              ...
              <TableCell className="flex py-2 gap-4" id={m.id}>
                <Sheet>
                  ...
                  <SheetContent>
                    <SheetHeader>
                      <SheetTitle>{t("adminMasters.edit")}</SheetTitle>
                    </SheetHeader>
                    <UpdateMaterForm
                      id={m.id}
                      page={page}
