          ...
          <Table>
            <TableHeader className="shadow-md bg-secondary sticky top-0 z-50">
              <TableRow className="text-sm md:text-base lg:text-lg max-md:hidden">
                <TableHead>
                  {t("settings.appointmentsUser.tableHeader.service")}
                </TableHead>
                <TableHead>
                  {t("settings.appointmentsUser.tableHeader.dt")}
                </TableHead>
                <TableHead>
                  {t("settings.appointmentsUser.tableHeader.master")}
                </TableHead>
                <TableHead>
                  {t("settings.appointmentsUser.tableHeader.status")}
                </TableHead>
              </TableRow>
            </TableHeader>
                      ...
                      <TableCell className="max-md:p-2">
                        <Badge
                          className={`${
                            ...
                            appointment.status === "DENIED" && "bg-red-500"
                          } ${
